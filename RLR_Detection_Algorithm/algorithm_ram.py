...
class AlgorithmRAM:
    """
    This class is a version of the proposed Algorithm for evaluating the maximum and mean RAM usage
    ...
    def finalize_memory_usage(self, total_frames):
        """Shows final memory usage report."""
        print("\n*** Memory Usage ***")
        print(f"Mean memory usage: {self.total_memory_usage / total_frames:.2f} MB")
        print(f"Maximum memory usage: {self.max_memory_usage:.2f} MB")
        tracemalloc.stop()
