...
class SetRegions:
    ...
    def add_region_pair(self, direction, coords=None):
    ...
    def set_regions(self):
        ...
        while self.videocapture.isOpened():
            ...
            if vid_frame_count == 10:
                add = input("Do you want to add more regions with YOLO model detections? [yes|no]\n")
                if add == "yes":
                    # Extract the results
                    ...
                    if results[0].boxes is not None:
                        ...
                        for box, cls in zip(boxes, clss):
                            if(cls == 9):
                                ...
                                if user_input == "yes":
                                    direction = input("What direction should the vehicles follow? [up|right|left]\n")
                                    self.add_region_pair(direction, box)
